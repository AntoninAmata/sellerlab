...
const T = {
  fr: {
    ...
    articles: [
      ...
      {
        title: 'Article 11 – Fonctionnalité Bookmarklet (plan Pro)',
        body: "Le plan Pro inclut un outil de type « bookmarklet » permettant d'automatiser le remplissage du formulaire de mise en vente sur la plateforme Vinted. Cet outil interagit avec le formulaire Vinted depuis le navigateur de l'utilisateur sans transmission de données à Vinted. L'utilisation de cette fonctionnalité est placée sous l'entière responsabilité de l'utilisateur. SellerLab AI ne peut être tenu responsable d'une suspension, restriction ou résiliation de compte Vinted consécutive à l'utilisation de cet outil. Les Conditions Générales d'Utilisation de Vinted s'appliquent en priorité et l'utilisateur s'engage à les respecter.",
      },
    ],
  ...
  en: {
    ...
    articles: [
      ...
      {
        title: 'Article 11 – Bookmarklet Feature (Pro Plan)',
        body: 'The Pro plan includes a bookmarklet tool that automates filling in the Vinted listing form. This tool interacts with the Vinted form directly in the user\'s browser without transmitting data to Vinted. Use of this feature is entirely at the user\'s own risk. SellerLab AI cannot be held liable for any Vinted account suspension, restriction or termination resulting from use of this tool. Vinted\'s Terms of Service take precedence and the user agrees to comply with them.',
      },
    ],
  ...
  es: {
    ...
    articles: [
      ...
      {
        title: 'Artículo 11 – Funcionalidad Bookmarklet (plan Pro)',
        body: 'El plan Pro incluye una herramienta de tipo bookmarklet que automatiza el relleno del formulario de publicación en Vinted. Esta herramienta interactúa con el formulario de Vinted directamente en el navegador del usuario sin transmitir datos a Vinted. El uso de esta funcionalidad es de exclusiva responsabilidad del usuario. SellerLab AI no puede ser responsable de la suspensión, restricción o cancelación de una cuenta Vinted derivada del uso de esta herramienta. Los Términos de Servicio de Vinted tienen prioridad y el usuario se compromete a respetarlos.',
      },
    ],
  ...
  it: {
    ...
    articles: [
      ...
      { title: 'Articolo 11 – Funzionalità Bookmarklet (piano Pro)', body: "Il piano Pro include uno strumento di tipo bookmarklet che automatizza la compilazione del modulo di pubblicazione su Vinted. Questo strumento interagisce con il modulo Vinted direttamente nel browser dell'utente senza trasmettere dati a Vinted. L'utilizzo di questa funzionalità è di esclusiva responsabilità dell'utente. SellerLab AI non può essere ritenuta responsabile di sospensioni, restrizioni o cancellazioni dell'account Vinted derivanti dall'uso di questo strumento. I Termini di Servizio di Vinted hanno la precedenza e l'utente si impegna a rispettarli." },
    ],
  ...
  de: {
    ...
    articles: [
      ...
      { title: 'Artikel 11 – Bookmarklet-Funktion (Pro-Plan)', body: 'Der Pro-Plan enthält ein Bookmarklet-Tool, das das Ausfüllen des Vinted-Inseratformulars automatisiert. Dieses Tool interagiert direkt im Browser des Nutzers mit dem Vinted-Formular, ohne Daten an Vinted zu übertragen. Die Nutzung dieser Funktion erfolgt auf alleinige Verantwortung des Nutzers. SellerLab AI haftet nicht für Sperrungen, Einschränkungen oder Kündigungen eines Vinted-Kontos infolge der Nutzung dieses Tools. Die Nutzungsbedingungen von Vinted haben Vorrang und der Nutzer verpflichtet sich, diese einzuhalten.' },
    ],
  ...
  pl: {
    ...
    articles: [
      ...
      { title: 'Artykuł 11 – Funkcja Bookmarklet (plan Pro)', body: 'Plan Pro zawiera narzędzie bookmarklet automatyzujące wypełnianie formularza wystawiania na Vinted. Narzędzie to działa bezpośrednio w przeglądarce użytkownika i nie przesyła danych do Vinted. Korzystanie z tej funkcji odbywa się na wyłączną odpowiedzialność użytkownika. SellerLab AI nie ponosi odpowiedzialności za zawieszenie, ograniczenie lub usunięcie konta Vinted wynikające z korzystania z tego narzędzia. Regulamin Vinted ma pierwszeństwo, a użytkownik zobowiązuje się go przestrzegać.' },
    ],
  ...
  nl: {
    ...
    articles: [
      ...
      { title: 'Artikel 11 – Bookmarklet-functie (Pro-plan)', body: 'Het Pro-plan bevat een bookmarklet-tool die het invullen van het Vinted-advertentieformulier automatiseert. Deze tool werkt rechtstreeks in de browser van de gebruiker en verzendt geen gegevens naar Vinted. Het gebruik van deze functie is volledig op eigen risico van de gebruiker. SellerLab AI is niet aansprakelijk voor schorsing, beperking of beëindiging van een Vinted-account als gevolg van het gebruik van deze tool. De gebruiksvoorwaarden van Vinted hebben voorrang en de gebruiker verbindt zich ertoe deze na te leven.' },
    ],
